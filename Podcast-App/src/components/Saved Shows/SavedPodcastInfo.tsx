 ...
 * @param onSave
 */
const SavedPodcastInfo: React.FC<OverlayProps> = ({ item, showOverlay, closeOverlay, onSave}) => {


    console.log('savedpodcastInfo')
    /**
    ...
    const fetchPodcastData = async (seasonId) => {
            ...
            if (!seasonId) {
                console.error('Error: seasonId is undefined');
                return; // Exit the function if seasonId is undefined
            }
    ...
    return (
        <>
            <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 z-[100] overflow-hidden">
...
export default SavedPodcastInfo;