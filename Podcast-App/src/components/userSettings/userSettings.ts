...
//  */
// export const markEpisodeCompleted = async (userId, selectedSeason, selectedEpisode, podcastData) => {
//
//
...
//             .insert([{
//                 user_id: userId,
//                 selected_season: selectedSeasonData.id,
//                 selected_episode: selectedEpisodeData.id,
...
//         }
//     } else {
//         console.error('Incomplete data provided. Cannot mark episode as completed.');
//         return false;
//     }
//     }
//
